...
var Invalid_Password = function Invalid_Password() {
...
var Inputs = function Inputs(_ref) {
  var OnInputChangeEmail = _ref.OnInputChangeEmail,
    OnInputChangePassword = _ref.OnInputChangePassword,
    OnInputChangeName = _ref.OnInputChangeName;
  return /*#__PURE__*/_react["default"].createElement("div", {
    id: "SignupInputs",
...
var Signup = /*#__PURE__*/function (_Component) {
  function Signup() {
    ...
    _defineProperty(_this, "handleInputChangeEmail", function (event) {
      var _event$target = event.target,
        name = _event$target.name,
        value = _event$target.value;
      _this.setState(_defineProperty({}, name, value));
    });
    _defineProperty(_this, "handleInputChangePassword", function (event) {
      var _event$target2 = event.target,
        name = _event$target2.name,
        value = _event$target2.value;
      _this.setState(_defineProperty({}, name, value));
    });
    _defineProperty(_this, "handleInputChangeName", function (event) {
    ...
    _defineProperty(_this, "handleSubmit", /*#__PURE__*/function () {
      var _ref2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(event) {
        var _this$state, email, password, confirm_password, name;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              event.preventDefault();
              _this$state = _this.state, email = _this$state.email, password = _this$state.password, confirm_password = _this$state.confirm_password, name = _this$state.name;
              ...
              _context.prev = 3;
              _context.next = 6;
              return _axios["default"].post('http://localhost:5050/Signup', {
                email: email,
                password: password,
                name: name
              });
    ...
    _defineProperty(_this, "showInputs", function (booleon) {
      _this.setState({
        showInput: booleon
      });
    });
